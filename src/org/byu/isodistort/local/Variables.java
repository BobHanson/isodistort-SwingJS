...
//	Global variables that are part of the Panel.
	...
	private IsoApp applet;

	public String isoversion;


	public Variables(IsoApp applet, String dataString, boolean isDiffraction)
	{		this.applet = applet;
			...
			initPanels(applet.sliderPanel, applet.controlPanel);
	} // end the constructor
...
//			System.out.println("t: "+t+", numSubTypes[t]: "+numSubTypes[t]+", boxesPerRow[t]: "+boxesPerRow[t]+", numCheckRows[t]: "+numCheckRows[t]);
			...
			dispPanel[t].setPreferredSize(new Dimension(sliderPanelWidth, dispmodePerType[t]*barheight));//size of slider labels
			...
			scalarPanel[t].setPreferredSize(new Dimension(sliderPanelWidth, scalarmodePerType[t]*barheight));//size of slider labels
			...
			magPanel[t].setPreferredSize(new Dimension(sliderPanelWidth, magmodePerType[t]*barheight));//size of slider labels
			...
			rotPanel[t].setPreferredSize(new Dimension(sliderPanelWidth, rotmodePerType[t]*barheight));//size of slider labels
			...
			ellipPanel[t].setPreferredSize(new Dimension(sliderPanelWidth, ellipmodePerType[t]*barheight));//size of slider labels
		...
		strainPanel.setPreferredSize(new Dimension(sliderPanelWidth, strainmodeNum*barheight));//size of slider labels
