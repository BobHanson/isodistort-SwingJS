...
/**
 * Deals with aspects of color and material properties of objects. Stores color
...
public class Material implements Runnable {
	 ...
	 * 
	 * @param an array of 4 doubles corresponding to r g b color components +
	 *           exponent
	 */
	 ...
	 * @return the material
	 */
	public Material setColor(double dr, double dg, double db, double sr, double sg, double sb, double sp, double ar,
			double ag, double ab) {
